    ...
    <div class="container">
        ...
        <form>
            <div class="form-group">
                <div class="form-row">
                    <div class="col-lg-2">
                        <label for="startDate" class="input-group date"><spring:message code="meal.startDate"/>:</label>
                        <input type="text" class="form-control" id="startDate" name="startDate" value="${param.startDate}"/>
                    </div>
                    <div class="col-lg-2">
                        <label for="endDate" class="input-group date"><spring:message code="meal.endDate"/>:</label>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        <label for="dateTime" class="input-group date"><spring:message code="meal.dateTime"/></label>
